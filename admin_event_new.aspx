<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="admin_event_new.aspx.cs" Inherits="admin_event_new" %>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-left"> 
							<li><a href="admin_home.aspx" class="btn w3ls-hover ">Home</a></li>
							 	<li><a href="#" class="dropdown-toggle  w3ls-hover active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Event <span class="caret"></span></a>
			...
			<h3>new event details</h3>
              ...
              <tr>
                  <td class="style6">
                      Date</td>
                  <td class="style6">
                      <asp:TextBox ID="TextBox5" runat="server" required="" TextMode="Date" 
              ...
              <tr>
                  <td class="style5">
                      Time</td>
                  <td class="style5">
                      <asp:TextBox ID="TextBox6" runat="server" required="" TextMode="Time" 
              ...
              <tr>
                  <td class="style2">
                      Email</td>
                  <td class="style2">
                      <asp:TextBox ID="TextBox8" runat="server" required="" TextMode="Email"></asp:TextBox>
                  </td>
              </tr>
              <tr>
                  <td class="style2">
                  ...
                  <td class="style2">
                      <asp:Button ID="Button1" runat="server" Text="ADD" Width="177px" 
